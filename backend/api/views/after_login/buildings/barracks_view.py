...
class TrainInfantryView(APIView):
    ...
    def post(self, request):
        ...
        if(user.has_resources_to_train_unit(village_id, unit_type, unit_name, number_of_units_to_train)):
            ...
            with transaction.atomic():
                set_sum_and_last_interaction_date_of_resource(user.id, village_id, 'woodCamp', current_resources['woodCamp']-reqiuredWood, now)
                set_sum_and_last_interaction_date_of_resource(user.id, village_id, 'clayPit', current_resources['ironMine']-reqiuredIron, now)
                set_sum_and_last_interaction_date_of_resource(user.id, village_id, 'ironMine', current_resources['clayPit']-reqiuredClay, now)
